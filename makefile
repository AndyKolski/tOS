NAME=tOS
TARGETS=start.o main.o libs.o gdt.o idt.o isrs.o irq.o timer.o kb.o display.o memory.o pcspeaker.o pit.o serial.o io.o stdio.o string.o mouse.o rtc.o time.o 
