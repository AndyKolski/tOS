...
_TARGETS=start.o display.o gdt.o idt.o io.o irq.o isrs.o keyboard.o libs.o main.o memory.o mouse.o paging.o pcspeaker.o pit.o rtc.o serial.o stdio.o string.o time.o ctype.o userland.o syscall.o
